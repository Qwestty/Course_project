...
<div class="profile">
    ...
    <div class="profile-container">
        <div class="profile-container_img">
            <div class="container_img">
                <img class="profile_img" src="../img/<?= $user['img'] ?>">
            </div>
            <div class="container_description">
                <p class="profile_login">Логин: <?php echo $user['login']?></p>
                <p class="profile_login">Имя: <?php echo $user['name']?></p>
                <p class="profile_login">Дата рождения: <?php echo $user['date']?></p>
                <a class="edit_btn" href="<?php echo get_url('edit_profile.php');?>">Редактировать</a>
            </div>
        </div>
    </div>
    <div class="profile-container_description">
        <div class="container_description_up">
            <p>Описание:</p>
            <p><?php echo $user['description']?></p>
        </div>
        <div class="container_description_down">
            <p>Тренировки:</p>
            <div class="programm_block">
                <?php if (!empty($orders)): ?>
                    <?php foreach ($orders as $order): ?>
                        <div class="programm_contain">
                            <p><?php echo $order['training_name']?><a class="programm_contain_a" href="<?php echo get_url('delete_order.php?id=' . $order['id']); ?>"><svg width="25px" height="25px" fill="white" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" class="icon">
                                        <path d="M360 184h-8c4.4 0 8-3.6 8-8v8h304v-8c0 4.4 3.6 8 8 8h-8v72h72v-80c0-35.3-28.7-64-64-64H352c-35.3 0-64 28.7-64 64v80h72v-72zm504 72H160c-17.7 0-32 14.3-32 32v32c0 4.4 3.6 8 8 8h60.4l24.7 523c1.6 34.1 29.8 61 63.9 61h454c34.2 0 62.3-26.8 63.9-61l24.7-523H888c4.4 0 8-3.6 8-8v-32c0-17.7-14.3-32-32-32zM731.3 840H292.7l-24.2-512h487l-24.2 512z"/>
                                    </svg>
                                </a></p>
                            <p><?php echo $order['training_description']?></p>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
            <?php if ($_SESSION['user']['role'] == '1'){?>
                <a class="edit_btn" href="<?php echo get_url('add_programm.php');?>">Добавить</a>
            <?php } ?>
        </div>
    </div>
    <p class="logo_profile">Редактирование: <?php if ($_SESSION['user']['role'] == '1'){?>
            Тренер
        <?php }else { ?>
            Клиент
        <?php } ?>
