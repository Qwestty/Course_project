...
?>
        ...
        <div class="header__container">
            <div class="header__navigation">
                <div class="header__logo">
                    <a class="logo_link" href="../pages/index.php">
                        <p class="logo">H&S</p>
                    </a>
                </div>
    ...
    <div class="login_block">
        <?php if (!empty($error)) {?>
            <div class="alert-dismissible alert-dismissible_login">
                <?php echo $error?>
            </div>
        <?php } ?>
        ...
        <div class="login_container">
            <div class="login_main">
                <div class="login_main_body2">
                    <div class="login_main_register">
                        <form class="register" method="post" action="">
                            ...
                            <div class="register_block">
                                <p>Логин:</p>
                                <input type="text" placeholder="Введите свой логин:" required name="login">
                                <p>Пароль:</p>
                                <input type="password" placeholder="Введите свой пароль:" required name="pass">
                            </div>
                            <div class="btn_register">
                                <button  type="submit" class="login_btn">Авторизоваться</button>
                            </div>
                        </form>
                    </div>
                </div>
