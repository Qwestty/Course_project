                    ...
                    <div class="login_main_register">
                        <form class="register" method="post" action="">
                            ...
                            <div class="register_block">
                                ...
                                <p>Пароль:</p>
                                <input type="password" placeholder="Введите пароль:" required name="pass">
                                <p>Повторный пароль:</p>
                                <input type="password" placeholder="Введите пароль:" required name="pass2">
                                <p>Имя:</p>
                                <input type="text" placeholder="Введите Имя:" required name="name">
                                <p>Дата рождения:</p>
                                <input type="date" placeholder="Введите дату рождения:" required name="date">
                            </div>
                            <div class="btn_register">
                            </div>
                            <button type="submit" class="register_btn">Зарегестрироваться</button>
                        </form>
                    </div>
                </div>
            </div>
