...
<form class="profile" method="post" action="<?php echo get_url('edit.php')?>">
    <div class="profile-container">
        <div class="profile-container_img">
            <div class="container_img">
                <img class="profile_img" src="../img/<?= $user['img']?>">
                <input class="profile_img" type="file" required name="img">
            </div>
            <div class="container_description">
                <input class="profile_login" type="text" placeholder="Введите логин:" value="<?php echo $user['login']?>" name="login">
                <input class="profile_login" type="text" placeholder="Введите ФИО:" value="<?php echo $user['name']?>" name="name">
                <input class="profile_login" type="date" placeholder="Введите дату рождения:" value="<?php echo $user['date']?>" name="date">
    ...
    <div class="profile-container_description">
        <div class="container_description_up">
            <p>Описание:</p>
            <input class="profile_login input_description" type="text" maxlength="750" placeholder="Напишите что-нибудь о себе:" value="<?php echo $user['description']?>" name="description">
        </div>
        <div class="container_description_down">
            <p>Тренировки:</p>
        </div>
    </div>
    <p class="logo_profile">Редактирование профиля</p>
</form>
