...
if (isset($_POST['comment']) || !empty($_POST['comment'])) {
    ...
    $date = date('H:i:s');
    post_comment($_GET['id'], $_POST['comment'], $date, $login);
    $_SESSION['success'] = "Комментарий успешно добавлен!";
    header('Location: index.php');
}
$comments = get_comment($_GET['id']);

$trainer_card = get_trainer_info($_GET['id']);

?>

<body class="color_background">
<?php include '../include/about_us.php'; ?>
<div class="train_add_programm">
    <div class="train_programm_container">
        <div class="train_programm_container_up">
            <div class="train_programm_container_up-img">
                <div class="programm_container_up-description">
                    <p><?= $trainer_card['name']?></p>
                </div>
                <img src="../img/<?= $trainer_card['img']?>" class="programm_container_up-img">
            </div>
        </div>
        <div class="train_programm_container_down">
            <div class="train_programm_container_down_p">
                <p align="justify"><?= $trainer_card['description']?></p>
            </div>
        </div>
    </div>
    <div class="comment">
        ...
        <div class="comment_block">
            <div class="comment_p">
                ...
                <form method="post" action="" class="form_comment">
                    <input type="text" required class="profile_login input_com" autocomplete="off" name="comment">
                    <button type="submit" class="btn_comment "><svg width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
