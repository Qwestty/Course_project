...
$training_card = get_product_info($_GET['id']);
?>

<body class="color_background">
<?php include '../include/about_us.php'; ?>
<div class="train_add_programm flex-direction">
        ...
        <div class="train_programm_container_up">
            <div class="train_programm_container_up-img">
                <div class="programm_container_up-description">
                    <p><?= $training_card['training_name']?></p>
                </div>
                <img src="../img/<?= $training_card['training_img']?>" class="programm_container_up-img">
            </div>
        </div>
        <div class="train_programm_container_down">
            <div class="train_programm_container_down_p">
                <p align="justify"><?= $training_card['training_text']?></p>
            </div>
        </div>
    </div>
    <?php if ($_SESSION['user']['role'] == '1'){?>
    <?php }else{ ?>
        <a class="add_btn" href="<?php echo out_url('buy.php?id=' . $_GET['id']); ?>">Добавить</a>
    <?php } ?>
</div>
<header class="header">
